<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formulariocamiones.aspx.cs" Inherits="Transporte_3Capas.Catalogos.Camiones.formulariocamiones" %>
...
<asp:TextBox ID="txttipo" runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <br />
                    <asp:CheckBox ID="chkdisponibilidad" runat="server" Text="Imagen" />
                    <br />
                    <br />
